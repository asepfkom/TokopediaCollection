...
Begin VB.Form RptCallTrackingServer5 
   Caption         =   "Report Time on System [Card Server 5]"
   ClientHeight    =   4635
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5955
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "rptCallTrackingServer5.frx":0000
         Left            =   240
         List            =   "rptCallTrackingServer5.frx":0002
         TabIndex        =   12
         Top             =   1620
         Visible         =   0   'False
         Width           =   1245
      ...
      Begin VB.ComboBox cmbReportName 
         Height          =   315
         ItemData        =   "rptCallTrackingServer5.frx":0004
         Left            =   1560
         List            =   "rptCallTrackingServer5.frx":0014
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbagentfullname 
            Height          =   315
            ItemData        =   "rptCallTrackingServer5.frx":008D
            Left            =   420
            List            =   "rptCallTrackingServer5.frx":008F
            TabIndex        =   4
            Top             =   600
            Width           =   2985
         End
      ...
      Begin TDBDate6Ctl.TDBDate TdTglCall1 
         ...
         _ExtentX        =   2302
         _ExtentY        =   556
         Calendar        =   "rptCallTrackingServer5.frx":0091
         Caption         =   "rptCallTrackingServer5.frx":01A9
         ...
         EndProperty
         DropDown        =   "rptCallTrackingServer5.frx":0215
         Keys            =   "rptCallTrackingServer5.frx":0233
         Spin            =   "rptCallTrackingServer5.frx":0291
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
      ...
      Begin TDBDate6Ctl.TDBDate TdTglCall2 
         ...
         _ExtentX        =   2302
         _ExtentY        =   556
         Calendar        =   "rptCallTrackingServer5.frx":02B9
         Caption         =   "rptCallTrackingServer5.frx":03D1
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "rptCallTrackingServer5.frx":043D
         Keys            =   "rptCallTrackingServer5.frx":045B
         Spin            =   "rptCallTrackingServer5.frx":04B9
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   -2147483643
   ...
   Begin VB.Image Image1 
      ...
      Index           =   4
      Left            =   60
      Picture         =   "rptCallTrackingServer5.frx":04E1
      Stretch         =   -1  'True
      Top             =   120
      Width           =   420
   End
   Begin VB.Image Image2 
      Height          =   585
      Left            =   0
      Picture         =   "rptCallTrackingServer5.frx":0FEB
      Stretch         =   -1  'True
      Top             =   0
      Width           =   6000
   End
End
Attribute VB_Name = "RptCallTrackingServer5"
...
Set connIcentra = New ADODB.Connection
 ...
 'STRKONEKSI = "Driver={PostgreSQL ANSI}; Server=localhost; PORT=5432; Database=icentra3; UID=admin; PWD=admin321"

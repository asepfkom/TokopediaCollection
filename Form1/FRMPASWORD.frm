...
Begin VB.Form FRMPASWORD 
   ...
   Caption         =   "Simpan Data Customer"
   ClientHeight    =   1710
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4680
   Icon            =   "FRMPASWORD.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
...
m_objrs.Open "SELECT USERID, PWD FROM USERTBL WHERE USERID = '" + txtUserName + "' AND USERTYPE <> 1 ", M_OBJCONN, adOpenDynamic, adLockOptimistic, adCmdText
If m_objrs.RecordCount <> 0 Then
    If txtPassword <> m_objrs("PWD") Then

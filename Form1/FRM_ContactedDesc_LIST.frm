...
Begin VB.Form FRM_ContactedDesc_LIST 
   BackColor       =   &H00C0C0C0&
   ...
   End
End
Attribute VB_Name = "FRM_ContactedDesc_LIST"
...
Private Sub Form_Load()
    ...
    While Not M_OBJRS.EOF
         Set listitem = ListView1.ListItems.ADD(, , M_OBJRS("KdNoProdPresented"))
             listitem.SubItems(1) = IIf(IsNull(M_OBJRS("NmNoProdPresented")), "", M_OBJRS("NmNoProdPresented"))
             listitem.SubItems(2) = IIf(IsNull(M_OBJRS("Jenis")), "", M_OBJRS("Jenis"))
        M_OBJRS.MoveNext
    Wend
        M_OBJRS.Close
        Set M_OBJRS = Nothing
...
Select Case Index
    Case 0
           With FRM_ContactedDesc
                .Caption = "Tambah"
                .Show vbModal
                If .ok Then
                    CMDSQL = "Insert into ContactedDesc "
                    CMDSQL = CMDSQL + "  (KdNoProdPresented, Jenis, NmNoProdPresented)"
    ...
    Case 1
        ...
        End If
            With FRM_ContactedDesc
                ...
                .Show vbModal
                If .ok Then
                    CMDSQL = "Update ContactedDesc "
                    CMDSQL = CMDSQL + " Set NmNoProdPresented= '" + .Text2.Text + "',"
                    CMDSQL = CMDSQL + " Jenis= '" + .Combo1.Text + "'"
                    CMDSQL = CMDSQL + " Where KdNoProdPresented= '" + .Text1.Text + "'"
                    On Error GoTo add_error
    ...
    Case 2
        ...
        If m_msgbox = 1 Then
            M_OBJCONN.Execute "Delete From ContactedDesc where KdNoProdPresented  ='" + ListView1.SelectedItem.Text + "'"

...
Begin VB.Form FRM_SETUSER_spv_Spt 
   BackColor       =   &H80000004&
   ...
   End
End
Attribute VB_Name = "FRM_SETUSER_spv_Spt"
...
Select Case Index
    Case 0
        ...
        Else
            ...
            FRM_distribute_spv_Spt.Show vbModal
        End If
    Case 1
        Unload Me
End Select
...
If m_objrs.RecordCount = 0 Then
    FRM_SETUSER_spv_Spt.ProgressBar1.Max = 100
Else
    FRM_SETUSER_spv_Spt.ProgressBar1.Max = 100 * (m_objrs.RecordCount + 1)
    
End If
    FRM_SETUSER_spv_Spt.ProgressBar1.Visible = True
    FRM_SETUSER_spv_Spt.ProgressBar1.Value = 100
i = 100
...
While Not m_objrs.EOF
    FRM_SETUSER_spv_Spt.ProgressBar1.Value = i
    ...
    i = i + 100
Wend
    FRM_SETUSER_spv_Spt.ProgressBar1.Value = FRM_SETUSER_spv_Spt.ProgressBar1.Max
    FRM_SETUSER_spv_Spt.ProgressBar1.Visible = False
End Function

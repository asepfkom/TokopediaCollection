...
Begin VB.Form Formupdate_status_ptp 
   Appearance      =   0  'Flat
   BackColor       =   &H00008000&
   ...
   Begin VB.CommandButton btntransferdata 
      Caption         =   "Approval Updater Status PTP"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.ComboBox cbsendapp 
      Height          =   315
      ItemData        =   "Formupdate_status_ptp.frx":0000
      Left            =   3840
      List            =   "Formupdate_status_ptp.frx":0007
      TabIndex        =   1
      Top             =   6480
      Width           =   1335
   End
   ...
   End
End
Attribute VB_Name = "Formupdate_status_ptp"
...
Private Sub btntransferdata_Click()
    ...
    formapprovalu_statusptp.Show vbModal
End Sub
...
Private Sub cbproses_Click()
    ...
    Dim sstatusptplama As String
    Dim sstatusptpbaru As String
        ...
        While Not rs.EOF
                ...
                sagentlama = IIf(IsNull(rs("statusptplama")), "", rs("statusptplama"))
                sagentbaru = IIf(IsNull(rs("statusptpbaru")), "", rs("statusptpbaru"))
                str_sql = "INSERT INTO tampungupdate_statusptp values ('" + scustid + "',"
                str_sql = str_sql + "'" + sstatusptplama + "', '" + sstatusptpbaru + "', now(), '" & MDIForm1.Text1.text & "', '" & cbsendapp.text & "')"
...
For i = 1 To Len("MGR1      !MGR1;")
        ...
        Case ";"
            cmdsql = "INSERT INTO tblpermohonanu_statusptp"

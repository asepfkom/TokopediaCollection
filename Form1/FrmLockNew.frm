...
Dim StsOS As String
Dim StsON As String
Dim StsNOAN As String
Dim StsPR As String
Dim StsPTP As String
Dim StsBP As String
Dim StsPOP As String
Dim StsNOCO As String
Dim StsRP As String
Dim StsOP As String
...
If Check1(5).Value Then
    StsNOCO = "NOCO-"
    '@@ 061110 Mencatat Status yang di lock u/ lock timer
    StatusLocked = StatusLocked + StsNOCO
End If
...
If Check1(11).Value Then
    StsNOAN = "NOAN-"
    '@@ 061110 Mencatat Status yang di lock u/ lock timer
    StatusLocked = StatusLocked + StsNOAN
End If
...
Public Function getblock() As String
                    ...
                    If StsNOCO <> "" Then
                        If Len(STRINGBLOK) = 0 Then
                                STRINGBLOK = " substring(F_cek_new,1,3)  in (@" + StsNOCO + "@"
                        Else
                                STRINGBLOK = STRINGBLOK + ",@" + StsNOCO + "@"
                        End If
                    End If
                    ...
                    If StsNOAN <> "" Then
                        If Len(STRINGBLOK) = 0 Then
                                'STRINGBLOK = " substring(F_cek_new,1,3)   in (@" + StsNOAN + "@"
                        'Else
                                'STRINGBLOK = STRINGBLOK + ",@" + StsNOAN + "@"
                                '===asep===02/04/2020'
                                STRINGBLOK = " F_cek_new   in (@" + StsNOAN + "@"
                                '============'
                        End If
                    End If

...
Begin VB.Form FRM_distribute_spv_Spt 
   BackColor       =   &H80000004&
   ...
   ClientTop       =   330
   ClientWidth     =   9390
   Icon            =   "FRM_DISTRIBUTE_spv_Spt.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7320
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FRM_DISTRIBUTE_spv_Spt.frx":0442
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame2"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Distribusi"
      TabPicture(1)   =   "FRM_DISTRIBUTE_spv_Spt.frx":045E
   ...
   End
End
Attribute VB_Name = "FRM_distribute_spv_Spt"
...
Text2.Text = 0
        JUMLAH = HITUNG_TEMPCUST_CC(M_OBJCONN, "AGENT ='" + MDIForm1.Text1.Text + "' and RECSOURCEREF = '" + Combo1(0).Text + "' ")
    ...
    Case 0
        ...
        ListView1.ListItems(i).Selected = True
            If ListView1.ListItems(i).SubItems(2) <> "0" Then
                ...
                cmdsql = cmdsql + " CUSTID FROM CC_CUSTTBL where AGENT ='" + MDIForm1.Text1.Text + "' and recsource ='" + Combo1(0).Text + "') "
...
Dim LISTITEM As LISTITEM
    ...
    Call header
    Call header1
    Set LISTITEM = ListView1.ListItems.ADD(, , FRM_SETUSER_spv_Spt.Combo1(0).Text)
        LISTITEM.SubItems(1) = FRM_SETUSER_spv_Spt.Combo1(1).Text
        LISTITEM.SubItems(2) = 0
        LISTITEM.SubItems(3) = Format(MDIForm1.TDBDate1.Text, "yyyymmdd") & Format(Now, "hhmm")
      
    Set m_objrs = QUERY_USER_ACC(M_RPTCONN, FRM_SETUSER_spv_Spt.Combo1(0).Text)
...
Set m_objrs = Nothing
'Call QUERY_SPV
Set m_objrs = QUERY_SPV(M_OBJCONN, " SPVCODE = '" + FRM_SETUSER_spv_Spt.Combo1(0).Text + "'")
If m_objrs.RecordCount <> 0 Then

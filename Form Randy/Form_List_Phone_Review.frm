...
Private Sub ReleaseReview()
    ...
    For w = 1 To LvPhoneReview.ListItems.Count
        If LvPhoneReview.ListItems(w).Checked = True Then
            ...
            hst = "REVIEW 5 KALI CALL RELEASE BY : " + UCase(MDIForm1.Text1.text) + " / " + LvPhoneReview.ListItems(w).ListSubItems(3)
            ...
            'jejaktian28032016
            cmdsql = "Update tblloglistreview set user_release = '" + MDIForm1.Text1.text + "'"

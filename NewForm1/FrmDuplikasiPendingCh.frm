...
Begin VB.Form FrmDuplikasiPendingCh 
   ...
   End
End
Attribute VB_Name = "FrmDuplikasiPendingCh"
...
CMDSQL = "Select * from Vw_PendingCloseDuplikasiCh where AGENT BETWEEN '" + kriteria1 + "' AND '" + kriteria2 + "' AND sts = 0"
...
M_OBJCONN.BeginTrans
    ...
    FRMCUST_CC_MGM.SSCommand1(5).Visible = True
    FRMCUST_CC_MGM.TxtReasonClosing = LstExLeads.SelectedItem.SubItems(12)

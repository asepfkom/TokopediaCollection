...
Begin VB.Form FrmDuplikasiPendingCh1 
   ...
   End
End
Attribute VB_Name = "FrmDuplikasiPendingCh1"
...
m_rs.Open "Select * from Vw_PendingCloseDuplikasiCh where agent between '" + kriteria1 + "' and  '" + kriteria2 + "' ", M_OBJCONN, adOpenDynamic, adLockOptimistic, adCmdText
While Not m_rs.EOF
...
M_OBJCONN.BeginTrans
    ...
    If FRMCUST_CC_MGM.closeOk = True Then
        M_OBJCONN.Execute "update Vw_PendingCloseDuplikasiCh set sts =1 where custidbaru ='" + LstExLeads.SelectedItem.SubItems(11) + "'"
        MsgBox "Done"
        Call isi_data(cmbAgentBaru(0), cmbAgentBaru(1))
    End If
    Unload FRMCUST_CC_MGM

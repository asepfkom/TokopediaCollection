...
Begin VB.Form Form_setting_upload 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(0)   =   "frm_setting_upload.frx":0000
         ...
         TabPicture(1)   =   "frm_setting_upload.frx":001C
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   0
      Picture         =   "frm_setting_upload.frx":0038
      Stretch         =   -1  'True
      Top             =   0
      Width           =   420
   End
   Begin VB.Image Image2 
      Height          =   465
      Left            =   0
      Picture         =   "frm_setting_upload.frx":0B42
      Stretch         =   -1  'True
      Top             =   0
      Width           =   15360
   End
End
Attribute VB_Name = "Form_setting_upload"
...
ssql = "SELECT * FROM  tbl_setting_upload WHERE KODE_SOURCE='" + cbomapsource + "'"
...
Else
   sStrsql = " select nama_kolom,field_destination from ( "
    ...
    sStrsql = sStrsql + "  select field_source,field_destination from tbl_setting_upload where kode_source='" + cbomapsource.Text + "' ) "
...
Dim rsTemp As New ADODB.Recordset
            ...
            ssql = "DELETE FROM tbl_setting_upload WHERE kode_source ='" & cbomapsource.Text & "'"
            M_OBJCONN.Execute (ssql)

            For brs = 1 To fx_mapping.Rows - 1
                If fx_mapping.TextMatrix(brs, 2) <> vbNullString Then
                    ssql = "INSERT INTO tbl_setting_upload (kode_source,nama_source,table_source ,location_source,field_source , field_destination) "
                    ssql = ssql & "VALUES "
                    With fx_mapping
    ...
    Strsql = "insert into tbl_hst_setting_upload (user_input,action_user) values ('" + MDIForm1.Text1.Text + "','" + sAction + "') "
...
cbomapsource.CLEAR
 ssql = "select DISTINCT(kode_source) from tbl_setting_upload "
 Set M_Objrs = New ADODB.Recordset
 M_Objrs.CursorLocation = adUseClient
 M_Objrs.Open ssql, M_OBJCONN, adOpenDynamic, adLockOptimistic
 While Not M_Objrs.EOF
